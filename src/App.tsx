  ...
  if (hasError) {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-red-50 dark:bg-red-950/20 p-4 transition-colors duration-300">
        <div className="bg-[#FCFAF7] dark:bg-[#161B26] p-8 rounded-2xl shadow-xl max-w-md w-full border border-red-100 dark:border-red-900/30">
...
const Onboarding = ({ onComplete }: { onComplete: (persona: Persona, interests: string[]) => void }) => {
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {personas.map((p) => (
            <motion.button
              ...
              className="bg-[#FCFAF7] dark:bg-[#161B26] p-8 rounded-3xl shadow-sm border border-gray-100 dark:border-[#202738] text-left flex flex-col items-start group hover:border-orange-200 dark:hover:border-orange-500/50 transition-all"
            >
  ...
  return (
    <div className="max-w-2xl mx-auto">
      ...
      <div className="bg-[#FCFAF7] dark:bg-[#161B26] p-8 rounded-3xl shadow-sm border border-gray-100 dark:border-[#202738]">
        <input
          type="text"
...
export default function App() {
  ...
  useEffect(() => {
    ...
    if (!apiKey) {
      console.error("CRITICAL ERROR: Gemini API key is missing. Please check your .env file and ensure GEMINI_API_KEY or VITE_GEMINI_API_KEY is set, then restart your dev server.");
    }
  }, []);
  ...
  const handleArticleClick = async (item: string) => {
    ...
    try {
      ...
      // Generate image AFTER text is done to avoid concurrent quota hits
      const url = await generateImage(title.trim());
      setArticleImage(url);
    } catch (e) {
      console.error(e);
  ...
  const handleGenerateBriefing = async () => {
    ...
    try {
      ...
      // Generate image AFTER text content to avoid concurrent quota hits
  ...
  if (loading) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-[#F5F2EB] dark:bg-[#0F111A] transition-colors duration-300">
  ...
  if (!user) {
    return (
      <div className="min-h-screen bg-[#F5F2EB] dark:bg-[#0F111A] flex flex-col items-center justify-center p-6 transition-colors duration-300">
        <motion.div 
  ...
  if (!profile) {
    return (
      <div className="min-h-screen bg-[#F5F2EB] dark:bg-[#0F111A] p-6 md:p-12 transition-colors duration-300">
  ...
  return (
    <ErrorBoundary>
      <div className="min-h-screen bg-[#F5F2EB] dark:bg-[#0F111A] flex flex-col md:flex-row transition-colors duration-300">
        {/* Sidebar */}
        <aside className="w-full md:w-72 bg-[#FCFAF7] dark:bg-[#161B26] border-r border-gray-100 dark:border-[#202738] p-6 flex flex-col transition-colors duration-300">
        ...
        {/* Main Content */}
        <main className="flex-1 bg-[#F5F2EB] dark:bg-[#0F111A] p-6 md:p-12 overflow-y-auto transition-colors duration-300">
          {/* Top Bar */}
          <div className="flex items-center justify-between mb-12">
            <div className="flex items-center gap-4">
              <div className="flex items-center gap-2 px-4 py-2 bg-[#FCFAF7] dark:bg-[#161B26] border border-gray-100 dark:border-[#202738] rounded-xl shadow-sm transition-colors duration-300">
                ...
                >
                  {ALL_LANGS.map(lang => (
                    <option key={lang} value={lang} className="dark:bg-[#161B26]">{lang}</option>
                  ))}
                </select>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4">
              <button 
                ...
                className="p-3 bg-[#FCFAF7] dark:bg-[#161B26] border border-gray-100 dark:border-[#202738] rounded-xl shadow-sm hover:bg-gray-50 dark:hover:bg-white/5 transition-all group"
              >
                {theme === 'light' ? (
          ...
          <AnimatePresence mode="wait">
              ...
              >
                {selectedArticle ? (
                  <div className="space-y-8">
                    ...
                    <div className="bg-[#FCFAF7] dark:bg-[#161B26] p-8 md:p-12 rounded-[2rem] shadow-sm border border-gray-100 dark:border-[#202738] relative">
                      ...
                      {translating && (
                        <div className="absolute inset-0 bg-white/50 dark:bg-black/50 backdrop-blur-[2px] z-10 flex items-center justify-center rounded-[2rem]">
                          <div className="flex items-center gap-2 bg-[#FCFAF7] dark:bg-[#161B26] px-4 py-2 rounded-full shadow-lg border border-gray-100 dark:border-[#202738]">
                        ...
                        {feed.map((item, i) => {
                          ...
                          return (
                            <motion.div 
                              ...
                              className="bg-[#FCFAF7] dark:bg-[#161B26] p-8 rounded-3xl shadow-sm border border-gray-100 dark:border-[#202738] hover:border-orange-200 dark:hover:border-orange-500/50 transition-all cursor-pointer group"
                            >
                ...
                <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
                  ...
                  <div className="flex gap-2">
                    <input 
                      ...
                      className="px-4 py-3 bg-[#FCFAF7] dark:bg-[#161B26] border border-gray-200 dark:border-[#202738] rounded-xl focus:outline-none focus:ring-2 focus:ring-orange-500/20 w-64 dark:text-white"
                    />
                    <button 
                  ...
                  <div className="space-y-8">
                    {briefingImage && (
                      <motion.div 
                        initial={{ opacity: 0, scale: 0.95 }}
                        animate={{ opacity: 1, scale: 1 }}
                        className="w-full h-[300px] md:h-[400px] rounded-[2rem] overflow-hidden shadow-lg border border-gray-100 dark:border-[#202738]"
                      >
                        <img 
                          src={briefingImage} 
                          alt="Briefing Visual" 
                ...
                {storyArc ? (
                  <div className="space-y-8">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                      <div className="bg-[#FCFAF7] dark:bg-[#161B26] p-8 rounded-[2rem] shadow-sm border border-gray-100 dark:border-[#202738]">
                          ...
                          {storyArc.timeline && storyArc.timeline.length > 0 ? (
                            <ResponsiveContainer width="100%" height="100%">
                              <AreaChart data={storyArc.timeline}>
                                ...
                                <CartesianGrid strokeDasharray="3 3" vertical={false} stroke={theme === 'dark' ? '#202738' : '#f3f4f6'} />
                      ...
                      <div className="bg-[#FCFAF7] dark:bg-[#161B26] p-8 rounded-[2rem] shadow-sm border border-gray-100 dark:border-[#202738]">
                        ...
                        <div className="flex flex-wrap gap-2">
                          {(storyArc.keyPlayers || []).map((player, i) => (
                            <span key={i} className="px-4 py-2 bg-gray-50 dark:bg-white/5 text-gray-700 dark:text-gray-300 rounded-full text-sm font-medium border border-gray-100 dark:border-[#202738]">
                              {player}
                            </span>
                          ))}
                        </div>
            ...
            {activeTab === 'story' && (
              ...
              >
                ...
                {currentStory ? (
                  <div className="space-y-8">
                    {currentStory.imageUrl && (
                      <motion.div 
                        initial={{ opacity: 0, scale: 0.95 }}
                        animate={{ opacity: 1, scale: 1 }}
                        className="w-full h-[300px] md:h-[400px] rounded-[2rem] overflow-hidden shadow-lg border border-gray-100 dark:border-[#202738] relative group"
                      >
                        <img 
                    ...
                    <div className="bg-[#FCFAF7] dark:bg-[#161B26] p-8 md:p-12 rounded-[2rem] shadow-sm border border-gray-100 dark:border-[#202738]">
                      <div className="flex justify-end mb-6">
                      ...
                      <div className="prose prose-orange dark:prose-invert max-w-none space-y-4">
                        {currentStory.story.split('\n').filter(line => line.trim()).map((line, i) => (
                          <p key={i} className={`text-xl md:text-2xl leading-relaxed ${i === 0 ? 'font-black text-gray-900 dark:text-white' : 'text-gray-600 dark:text-gray-400'} ${line.toLowerCase().startsWith('why it matters') ? 'pt-6 border-t border-gray-100 dark:border-[#202738] font-bold text-orange-600 dark:text-orange-400' : ''}`}>
                            {line}
                          </p>
                        ))}
                      </div>
                  ...
                  <div className="h-[400px] bg-gray-50 dark:bg-white/5 rounded-[2rem] border-2 border-dashed border-gray-200 dark:border-[#202738] flex flex-col items-center justify-center text-gray-400">
            ...
            {activeTab === 'podcast' && (
              ...
              >
                ...
                <div className="bg-[#FCFAF7] dark:bg-[#161B26] p-12 rounded-[3rem] shadow-2xl border border-gray-100 dark:border-[#202738] relative overflow-hidden">
            ...
            {activeTab === 'chat' && (
              ...
              >
                ...
                <div className="flex-1 bg-[#FCFAF7] dark:bg-[#161B26] rounded-[2rem] shadow-sm border border-gray-100 dark:border-[#202738] flex flex-col overflow-hidden">
                  <div className="flex-1 overflow-y-auto p-6 space-y-6">
                    ...
                    {chatMessages.map((msg, i) => (
                      <div key={i} className={`flex ${msg.role === 'user' ? 'justify-end' : 'justify-start'}`}>
                        <div className={`max-w-[80%] p-4 rounded-2xl ${msg.role === 'user' ? 'bg-orange-500 text-white' : 'bg-gray-50 dark:bg-white/5 text-gray-900 dark:text-white border border-gray-100 dark:border-[#202738]'}`}>
                    ...
                    {isChatLoading && (
                      <div className="flex justify-start">
                        <div className="bg-gray-50 dark:bg-white/5 p-4 rounded-2xl border border-gray-100 dark:border-[#202738] flex items-center gap-2">
                          <Loader2 className="w-4 h-4 animate-spin text-orange-500" />
                  ...
                  <div className="p-4 border-t border-gray-100 dark:border-[#202738] bg-gray-50/50 dark:bg-black/20">
                    <div className="flex gap-2">
                      <input 
                        type="text" 
                        value={chatInput}
                        ...
                        className="flex-1 px-4 py-3 bg-[#FCFAF7] dark:bg-[#161B26] border border-gray-200 dark:border-[#202738] rounded-xl focus:outline-none focus:ring-2 focus:ring-orange-500/20 dark:text-white"
                      />
                      <button 
          ...
          {selectedEntity && (
            <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40 backdrop-blur-sm">
              <motion.div 
                ...
                className="bg-[#FCFAF7] dark:bg-[#161B26] w-full max-w-2xl rounded-[2.5rem] shadow-2xl overflow-hidden flex flex-col max-h-[80vh] border border-gray-100 dark:border-[#202738]"
              >
                <div className="p-8 border-b border-gray-100 dark:border-[#202738] flex items-center justify-between bg-gray-50/50 dark:bg-white/5">
                  <div>
                  ...
                  <button 
                    ...
                    className="w-10 h-10 bg-[#FCFAF7] dark:bg-white/10 rounded-full shadow-sm border border-gray-100 dark:border-[#202738] flex items-center justify-center hover:bg-gray-50 dark:hover:bg-white/20 transition-colors"
                  >
